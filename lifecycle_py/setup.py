...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            "moverobot_lifecycle_server = lifecycle_py.moverobot_lifecycle_server:main",
            "moverobot_lifecycle_node_manager = lifecycle_py.moverobot_lifecycle_node_manager:main"
        ],
    },
)
